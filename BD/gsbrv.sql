...
CREATE TABLE `RapportVisite` (
  ...
  `rap_coeffconfiance` int(11) DEFAULT NULL,
...
INSERT INTO `RapportVisite` VALUES ('a131',1,'2021/11/08','bonne visite','visite quotidienne','2021/11/08',5,1),('a17',2,'2021/11/10','bonne visite','visite quotidienne','2021/11/10',4,6),('a55',3,'2021/11/12','bonne visite','visite quotidienne','2021/11/12',3,11),('a93',4,'2021/11/15','bonne visite','visite quotidienne','2021/11/15',2,16),('b13',5,'2021/11/17','bonne visite','visite quotidienne','2021/11/17',1,21),('b16',6,'2021/11/19','bonne visite','visite quotidienne','2021/11/19',0,26),('a131',7,'2021/12/08','bonne visite','visite quotidienne','2021/12/08',3,1),('a17',8,'2021/12/10','bonne visite','visite quotidienne','2021/12/10',5,6);
